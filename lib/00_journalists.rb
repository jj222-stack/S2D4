...
def contient_chiffres(str)
  str=~/[0-9]/
end

print "Question 1: nb journalistes="
print journalistes.length
puts " " 

print "Question 2: nb handle avec numéro = "
nb=0
journalistes.each do | journalist|
  if (journalist=~/[0-9]/)
  #  puts "#{journalist}"
    nb=nb+1
    end
...
print "Question 3 : nb handle avec Aude ="
nb=0
journalistes.each do | journalist|
  if (journalist=~/Aude/)
#  puts "#{journalist}"
...
print "Question 4 : nb handle commencant par une masjucule ="
...
print "Question 5: nb handle contenant au moins une majuscule="
...
print "Question 6 : nb handle contenant un _ =" 
...
print "Question 7: tri par ordre alphabetique"

jtries=journalistes.sort

puts"#{jtries}"
puts " "


print "Question 9: 50 handles les plus courts : "
puts " " 
